...
export default function About() {
  return (
    <div className="about">
      ...
      <p>
        The website leverages <ATag href={SPACEX_API_LINK} text="SpaceX API" />{" "}
        and <ATag href={NASA_API_LINK} text="NASA API" /> to display SpaceX's
        mission information and the weather on Mars. It's written using ReactJS,
        Bootstrap. This site is not for commercial use, and doesn't have
        relations to either SpaceX or NASA in any kinds.
      </p>
